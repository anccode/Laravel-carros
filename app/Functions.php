<?php
    ...
    CLass Functions{
        ...
        public function num_letras($xcifra){
        //------		CONVERTIR NUMEROS A SOLES		  ---------------
        //------    Máxima cifra soportada: 18 dígitos con 2 decimales
        //------    999,999,999,999,999,999.99
        // NOVECIENTOS NOVENTA Y NUEVE MIL NOVECIENTOS NOVENTA Y NUEVE BILLONES
        //	NOVECIENTOS NOVENTA Y NUEVE MIL NOVECIENTOS NOVENTA Y NUEVE MILLONES
        //	NOVECIENTOS NOVENTA Y NUEVE MIL NOVECIENTOS NOVENTA Y NUEVE SOLES 99/100 M.N.
                    ...
                    switch ($xy)
                        ...
                        case 1: // checa las centenas
                            if (substr($xaux, 0, 3) < 100) // si el grupo de tres dígitos es menor a una centena ( < 99) no hace nada y pasa a revisar las decenas
                                ...
                                if ($xseek)
                                    {
                                    $xsub = Functions::subfijo($xaux); // devuelve el subfijo correspondiente (Millón, Millones, Mil o nada)
